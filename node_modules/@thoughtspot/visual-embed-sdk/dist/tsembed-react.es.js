/* @thoughtspot/visual-embed-sdk version 1.52.1 */
'use client';
...
(function (Param) {
    ...
    Param["ShowAnswerEditPanel"] = "showAnswerEditPanel";
})(Param || (Param = {}));
/**
...
(function (Action) {
     ...
     * ```
     */
    Action["ChartTypeSettings"] = "CHART_TYPE";
    /**
     ...
     * ```
     */
    Action["DataLabelSettings"] = "DATA_LABEL";
    /**
     ...
     * ```
     */
    Action["TooltipSettings"] = "TOOLTIP";
    /**
     ...
     * ```
     */
    Action["DisplaySettings"] = "DISPLAY";
    /**
     ...
     * ```
     */
    Action["QuerySettings"] = "QUERY_DETAILS";
    /**
     ...
     * ```
     */
    Action["CustomSettings"] = "CUSTOM_ACTION";
    /**
     ...
     * ```
     */
    Action["RAnalysisSettings"] = "R_ANALYSIS";
    /**
     ...
     * ```
     */
    Action["AddToCollection"] = "addToCollection";
    /**
     ...
     * ```
     */
    Action["MoveToCollection"] = "moveToCollection";
    /**
     ...
     * ```
     */
    Action["RemoveFromCollection"] = "removeFromCollection";
    /**
     ...
     * ```
     */
    Action["DeleteCollection"] = "deleteCollection";
})(Action || (Action = {}));
...
var version$1="1.52.1";var pkg = {version:version$1};
 ...
 */
const resolveMessageOrigin = (thoughtSpotHost) => {
    try {
 ...
 */
const isMessageFromIframe = (event, iFrame, thoughtSpotHost) => {
    ...
    if (expectedOrigin && event.origin && event.origin !== expectedOrigin) {
        logger$3.warn(`Dropped message from unexpected origin ${event.origin}; expected ${expectedOrigin}`);
        return false;
    }
    return true;
};
 ...
 * @param channel
 */
const postMessageToIframe = (iFrame, message, thoughtSpotHost, channel) => {
    var _a;
...
class AnswerService {
    ...
    async getTML() {
        ...
        const YAML = await import('./index-C1pmYb5H.js');
...
const TRIGGER_TIMEOUT = MESSAGE_RESPONSE_TIMEOUT;
/**
...
class TsEmbed {
    ...
    async getUpdateEmbedParamsObject() {
        ...
        return {
            ...
            runtimeParameterParams: getRuntimeParameters((_b = this.viewConfig.runtimeParameters) !== null && _b !== void 0 ? _b : [])
                || NO_RUNTIME_PARAMS,
        };
    }
    /**
    ...
    getPreRenderObj() {
        ...
        if (embedObj === this) {
            logger$3.debug('embedObj is same as this');
        }
        return embedObj;
    }
    takeOverPreRender() {
...
let SearchEmbed$1 = class SearchEmbed extends TsEmbed {
    ...
    getEmbedParamsObject() {
        var _a;
        const { hideResults, enableSearchAssist, forceTable, searchOptions, runtimeFilters, dataSource, dataSources, excludeRuntimeFiltersfromURL, hideSearchBar, dataPanelV2 = true, useLastSelectedSources = false, runtimeParameters, collapseSearchBarInitially = false, enableCustomColumnGroups = false, dataPanelCustomGroupsAccordionInitialState = DataPanelCustomColumnGroupsAccordionState$1.EXPAND_ALL, focusSearchBarOnRender = true, excludeRuntimeParametersfromURL, excludeSearchTokenStringFromURL, collapseSearchBar = true, isThisPeriodInDateFiltersEnabled, newChartsLibrary, hideAnswerEditPanel, } = this.viewConfig;
        const queryParams = this.getBaseQueryParams();
...
class FullHeightController {
    constructor(viewConfig, host) {
        ...
        this.handleRequestVisibleCoordinates = (payload, responder) => {
            logger$3.info('Sending RequestVisibleEmbedCoordinates', payload);
            responder === null || responder === void 0 ? void 0 : responder({
...
let AppEmbed$1 = class AppEmbed extends V1Embed {
    ...
    getEmbedParamsObject() {
        ...
        if (!isUndefined$1(hideAnswerEditPanel)) {
        ...
        this.executeAfterEmbedContainerLoaded(async () => {
            ...
            if (this.isShowingLiveboardRoute(showing)) {
                ...
                this.trigger(HostEvent.Navigate, HOME_ROUTE)
                    .catch((error) => logger$3.warn('Could not route via home', error));
