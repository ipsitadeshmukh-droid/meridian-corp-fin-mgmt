...
describe('App embed tests', () => {
    ...
    test('should register event handlers to adjust iframe height', async () => {
        ...
        embedIframeCenterCallback({ type: EmbedEvent.EmbedIframeCenter, data: {} }, centerResponder);
        ...
        await executeAfterWait(() => {
            ...
            expect(centerResponder).toHaveBeenCalledWith(expect.objectContaining({ type: EmbedEvent.EmbedIframeCenter }));
        }, 100);
    ...
    describe('LazyLoadingForFullHeight functionality', () => {
        ...
        test('should default lazyLoadingMargin when lazyLoadingForFullHeight is set explicitly', async () => {
            ...
            await appEmbed.render();
            await executeAfterWait(() => {
                expect(getIFrameSrc()).toContain(`rootMarginForLazyLoad=${encodeURIComponent(config.DEFAULT_LAZY_LOADING_MARGIN)}`);
            }, 100);
        });
        ...
        test('should send correct visible data when RequestFullHeightLazyLoadData is triggered', async () => {
            ...
            appEmbed.fullHeightController.sendVisibleCoordinates();
        ...
        test('should handle RequestVisibleEmbedCoordinates event and respond with correct data', async () => {
            ...
            appEmbed.fullHeightController.handleRequestVisibleCoordinates({}, mockResponder);
...
describe('AppEmbed uncovered branch tests', () => {
    ...
    test('lazy load registration should return early when iFrame is not set', () => {
        ...
        expect(() => {
            appEmbed.fullHeightController.onRender();
        }).not.toThrow();
    });
});
