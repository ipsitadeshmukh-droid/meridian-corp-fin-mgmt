...
describe('Liveboard/viz embed tests', () => {
    ...
    test('should set isLiveboardAlwaysOn12ColLayout to true in url', async () => {
        ...
        liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}&isLiveboardAlwaysOn12ColLayout=true${prefixParams}#/embed/viz/${liveboardId}`);
        });
    });
    ...
    test('should set liveboardGutter in url', async () => {
        ...
        liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}&liveboardGutter=8${prefixParams}#/embed/viz/${liveboardId}`);
        });
    });
    test('should set liveboardGutter to 0 in url', async () => {
        ...
        liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}&liveboardGutter=0${prefixParams}#/embed/viz/${liveboardId}`);
        });
    });
    ...
    test('should add isScopedLiveboardFilteringEnabled flag and set value to true to the iframe src', async () => {
        ...
        liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}&isScopedLiveboardFilteringEnabled=true${prefixParams}#/embed/viz/${liveboardId}`);
        });
    });
    test('should add isScopedLiveboardFilteringEnabled flag and set value to false to the iframe src', async () => {
        ...
        liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}&isScopedLiveboardFilteringEnabled=false${prefixParams}#/embed/viz/${liveboardId}`);
        });
    });
    ...
    test('should render the liveboard embed with showSpotterRadiance', async () => {
        ...
        await liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}${prefixParams}&showSpotterRadiance=true#/embed/viz/${liveboardId}`);
        });
    });
    test('should render the liveboard embed with showSpotterRadiance disabled', async () => {
        ...
        await liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}${prefixParams}&showSpotterRadiance=false#/embed/viz/${liveboardId}`);
        });
    });
    ...
    describe('LazyLoadingForFullHeight functionality', () => {
        ...
        test('should default lazyLoadingMargin when lazyLoadingForFullHeight is set explicitly', async () => {
            ...
            await liveboardEmbed.render();
            await executeAfterWait(() => {
                expect(getIFrameSrc()).toContain(`rootMarginForLazyLoad=${encodeURIComponent(DEFAULT_LAZY_LOADING_MARGIN)}`);
            }, 100);
        });
        ...
        test('should send correct visible data when RequestVisibleEmbedCoordinates is triggered', async () => {
            ...
            liveboardEmbed.fullHeightController.sendVisibleCoordinates();
        ...
        test('should handle RequestVisibleEmbedCoordinates event and respond with correct data', async () => {
            ...
            liveboardEmbed.fullHeightController.handleRequestVisibleCoordinates({}, mockResponder);
    ...
    describe('Liveboard Embed Container Loading and PreRender', () => {
        ...
        test('should route via home when the pre-render is already on this route', async () => {
            ...
            jest.spyOn(liveboardEmbed, 'getPreRenderObj').mockReturnValue({
            ...
            expect(triggerSpy.mock.invocationCallOrder[0]).toBeLessThan(navigateToLiveboardSpy.mock.invocationCallOrder[0]);
        });
        test('should not wait for the container to acknowledge the home hop', async () => {
            ...
            jest.spyOn(liveboardEmbed, 'trigger').mockImplementation((event, payload) => (event === HostEvent.Navigate && payload === 'home'
                ? new Promise(() => { })
        ...
        test('should not route via home when the embed is showing itself again', async () => {
            ...
            jest.spyOn(liveboardEmbed, 'getPreRenderObj').mockReturnValue(liveboardEmbed);
            const triggerSpy = jest
                .spyOn(liveboardEmbed, 'trigger')
                .mockImplementation(() => Promise.resolve(undefined));
            const navigateToLiveboardSpy = jest
...
describe('LiveboardEmbed updatedSpotterExperience tests', () => {
    ...
    test('should render the liveboard embed with updatedSpotterExperience', async () => {
        ...
        await liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}${prefixParams}&updatedSpotterExperience=true#/embed/viz/${liveboardId}`);
        });
    });
    test('should render the liveboard embed with updatedSpotterExperience disabled', async () => {
        ...
        await liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}${prefixParams}&updatedSpotterExperience=false#/embed/viz/${liveboardId}`);
        });
    });
