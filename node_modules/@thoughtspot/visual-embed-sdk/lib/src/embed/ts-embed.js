...
import { getEncodedQueryParamsString, getCssDimension, embedEventStatus, setAttributes, getCustomisations, getRuntimeFilters, getDOMNode, querySelectorAcrossShadowRoot, getFilterQuery, getQueryParamString, getRuntimeParameters, setStyleProperties, removeStyleProperties, getHostEventsConfig, deserializeParam, } from '../utils';
...
import { AuthType, HostEvent, EmbedEvent, Action, Param, ContextMenuTriggerOptions, EmbedErrorSeverity, ErrorDetailsTypes, EmbedErrorCodes, } from '../types';
...
export class TsEmbed {
    ...
    inheritPreRenderContainer() {
        ...
        if (this.getPreRenderConfig().containerSelector
            ...
            logger.warn('preRenderContainer is applied only by the component that creates the preRender; '
