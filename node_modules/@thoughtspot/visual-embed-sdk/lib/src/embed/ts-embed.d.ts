 ...
 */
import { UIPassthroughArrayResponse, UIPassthroughEvent, UIPassthroughRequest } from '../contracts/ui-passthrough-contracts';
...
import { DOMSelector, HostEvent, EmbedEvent, MessageCallback, Action, EmbedConfig, MessageOptions, ContextMenuTriggerOptions, DefaultAppInitData, AllEmbedViewConfig as ViewConfig, EmbedErrorDetailsEvent, ContextType, ContextObject, PreRenderConfig } from '../types';
...
export declare class TsEmbed {
    ...
    protected getUpdateEmbedParamsObject(): Promise<{
        ...
        customisations: import("../types").CustomisationsInterface;
        authToken: string;
        hiddenHomepageModules: import("../types").HomepageModule[];
        reorderedHomepageModules: string[];
        hostConfig: Record<string, any>;
        hiddenHomeLeftNavItems: string[];
        customVariablesForThirdPartyTools: Record<string, any>;
        hiddenListColumns: import("../types").ListPageColumns[];
        customActions: import("../types").CustomAction[];
        ...
        frameParams?: import("../types").FrameParams;
        theme?: string;
        ...
        customizations?: import("../types").CustomisationsInterface;
        ...
        runtimeFilters?: import("../types").RuntimeFilter[];
        runtimeParameters?: import("../types").RuntimeParameter[];
