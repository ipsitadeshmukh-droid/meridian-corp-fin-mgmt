...
describe('ConversationEmbed', () => {
    ...
    it('should deep-link to the shared-conversation reader view when sharedConversationId is set', async () => {
        ...
        const conversationEmbed = new SpotterEmbed(getRootEl(), viewConfig);
        await conversationEmbed.render();
        expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/v2/?${defaultParams}&isSpotterExperienceEnabled=true#/embed/insights/conv-assist/s/conv-123?worksheet=worksheetId&query=searchQuery`);
    });
    it('should URL-encode the sharedConversationId in the reader-view path', async () => {
        ...
        const conversationEmbed = new SpotterEmbed(getRootEl(), viewConfig);
        await conversationEmbed.render();
        expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/v2/?${defaultParams}&isSpotterExperienceEnabled=true#/embed/insights/conv-assist/s/conv%2F1?worksheet=worksheetId&query=searchQuery`);
    });
    ...
    it('should render the conversation embed with spotter radiance', async () => {
        ...
        const conversationEmbed = new SpotterEmbed(getRootEl(), viewConfig);
        await conversationEmbed.render();
        expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/v2/?${defaultParams}&isSpotterExperienceEnabled=true&showSpotterRadiance=true#/embed/insights/conv-assist?worksheet=worksheetId&query=searchQuery`);
    });
    it('should render the conversation embed with spotter radiance disabled', async () => {
        ...
        const conversationEmbed = new SpotterEmbed(getRootEl(), viewConfig);
        await conversationEmbed.render();
        expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/v2/?${defaultParams}&isSpotterExperienceEnabled=true&showSpotterRadiance=false#/embed/insights/conv-assist?worksheet=worksheetId&query=searchQuery`);
    });
    ...
    it('should render the conversation embed with spotterAnalystConfig.analystId in the url', async () => {
        ...
        const conversationEmbed = new SpotterEmbed(getRootEl(), viewConfig);
        await conversationEmbed.render();
        expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/v2/?${defaultParams}&isSpotterExperienceEnabled=true&analystId=analyst-id-1234#/embed/insights/conv-assist?worksheet=worksheetId&query=searchQuery`);
    });
...
describe('SpotterEmbed APP_INIT embedParams', () => {
    ...
    it('should forward spotterChatPinConfig nested in spotterSidebarConfig', async () => {
        ...
        expect(response.data.embedParams.spotterSidebarConfig.spotterChatPinConfig).toEqual(spotterChatPinConfig);
    });
    ...
    it('should not handle error when neither worksheetId nor dataSources is provided', async () => {
        ...
        await conversationEmbed.render();
        expect(conversationEmbed.handleError).not.toHaveBeenCalled();
    });
    ...
    it('should render the conversation embed with dataSources and no worksheetId in the hash params', async () => {
        ...
        const conversationEmbed = new SpotterEmbed(getRootEl(), viewConfig);
        await conversationEmbed.render();
        expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/v2/?${defaultParams}&isSpotterExperienceEnabled=true#/embed/insights/conv-assist?dataSources=${encodeURIComponent(JSON.stringify(['ds-1', 'ds-2']))}`);
    });
    it('should prefer dataSources over worksheetId when both are provided', async () => {
        ...
        const conversationEmbed = new SpotterEmbed(getRootEl(), viewConfig);
        await conversationEmbed.render();
        expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/v2/?${defaultParams}&isSpotterExperienceEnabled=true#/embed/insights/conv-assist?query=searchQuery&dataSources=${encodeURIComponent(JSON.stringify(['ds-1', 'ds-2']))}`);
    });
...
describe('SpotterEmbed updatedSpotterExperience', () => {
    it('should render the conversation embed with updated spotter experience', async () => {
        ...
        const conversationEmbed = new SpotterEmbed(getRootEl(), viewConfig);
        await conversationEmbed.render();
        expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/v2/?${defaultParams}&isSpotterExperienceEnabled=true&updatedSpotterExperience=true#/embed/insights/conv-assist?worksheet=worksheetId&query=searchQuery`);
    });
    it('should render the conversation embed with updated spotter experience disabled', async () => {
        ...
        const conversationEmbed = new SpotterEmbed(getRootEl(), viewConfig);
        await conversationEmbed.render();
        expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/v2/?${defaultParams}&isSpotterExperienceEnabled=true&updatedSpotterExperience=false#/embed/insights/conv-assist?worksheet=worksheetId&query=searchQuery`);
    });
});
describe('SpotterEmbed APP_INIT starterPrompts', () => {
    ...
    it('should not include starterPrompts in embedParams when not configured', async () => {
        var _a;
        const response = await getAppInitResponse({ worksheetId: 'ws1' });
        expect((_a = response.data.embedParams) === null || _a === void 0 ? void 0 : _a.starterPrompts).toBeUndefined();
    });
