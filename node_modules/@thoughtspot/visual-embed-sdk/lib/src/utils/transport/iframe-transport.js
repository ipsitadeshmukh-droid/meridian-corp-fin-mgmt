 ...
 */
export const resolveMessageOrigin = (thoughtSpotHost) => {
    try {
 ...
 */
export const isMessageFromIframe = (event, iFrame, thoughtSpotHost) => {
 ...
 * @param channel
 */
export const postMessageToIframe = (iFrame, message, thoughtSpotHost, channel) => {
    var _a;
 ...
 * @param timeoutMs
 */
export function sendMessageWithResponse(iFrame, message, thoughtSpotHost, timeoutMs = MESSAGE_RESPONSE_TIMEOUT) {
...
//# sourceMappingURL=iframe-transport.js.map