    ...
    describe('preRenderId via preRenderConfig', () => {
        ...
        describe('routing to the preRender methods', () => {
            ...
            it('Should preRender PreRenderedLiveboardEmbed with preRenderConfig.id', () => {
                render(React.createElement(PreRenderedLiveboardEmbed, { preRenderConfig: { id: preRenderId }, liveboardId: "test-liveboard" }));
            ...
            it('Should preRender PreRenderedLiveboardEmbed with the top-level preRenderId', () => {
                render(React.createElement(PreRenderedLiveboardEmbed, { preRenderId: preRenderId, liveboardId: "test-liveboard" }));
                expect(preRenderSpy).toHaveBeenCalledTimes(1);
                expect(renderSpy).not.toHaveBeenCalled();
            });
            it('Should showPreRender the LiveboardEmbed connected via preRenderConfig', () => {
                const { unmount } = render(React.createElement(LiveboardEmbed, { preRenderConfig: { id: preRenderId }, liveboardId: "test-liveboard" }));
            ...
            it('Should showPreRender the LiveboardEmbed connected via the top-level preRenderId', () => {
                const { unmount } = render(React.createElement(LiveboardEmbed, { preRenderId: preRenderId, liveboardId: "test-liveboard" }));
                expect(showPreRenderSpy).toHaveBeenCalledTimes(1);
                expect(renderSpy).not.toHaveBeenCalled();
                unmount();
                expect(hidePreRenderSpy).toHaveBeenCalledTimes(1);
            ...
            it('Should render and destroy the LiveboardEmbed without any preRender id', () => {
                const { unmount } = render(React.createElement(LiveboardEmbed, { liveboardId: "test-liveboard" }));
        ...
        describe('pre-render wrapper element', () => {
            ...
            it('Should prefer preRenderConfig.id over the top-level preRenderId', async () => {
                render(React.createElement(PreRenderedLiveboardEmbed, { preRenderId: "top-level-pre-render-id", preRenderConfig: { id: 'config-pre-render-id' }, liveboardId: "test-liveboard" }));
                await waitFor(() => expect(document.getElementById(wrapperId('config-pre-render-id'))).not.toBe(null));
