...
describe('deserializeParam', () => {
    ...
    test('does not URI-decode strings — raw %xx content must survive', () => {
        expect(deserializeParam('%5Bcommit%20date%5D%5Brevenue%5D')).toBe('%5Bcommit%20date%5D%5Brevenue%5D');
    });
