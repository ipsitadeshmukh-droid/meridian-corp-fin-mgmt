...
describe('event contracts (drift guardrails)', () => {
    ...
    test('every typed host event is a real HostEvent member', () => {
        const allHostEventValues = new Set(Object.values(HostEvent));
