...
const HOST_EVENT_CONTRACTS_PATH = path.join(__dirname, '..', 'contracts', 'host-event-contracts.ts');
...
const extractPayloadLinkTargets = (source) => {
...
describe('react/all-types-export parity with index', () => {
    ...
    it('every payload type linked from docs is exported from both entry points', () => {
        ...
        const linked = new Set([
            ...
            ...extractPayloadLinkTargets(fs.readFileSync(HOST_EVENT_CONTRACTS_PATH, 'utf8')),
        ]);
