...
const ts_embed_1 = require("../embed/ts-embed");
...
describe('React Components', () => {
    ...
    describe('preRenderId via preRenderConfig', () => {
        ...
        describe('routing to the preRender methods', () => {
            let preRenderSpy;
            let showPreRenderSpy;
            let hidePreRenderSpy;
            let renderSpy;
            let destroySpy;
            beforeEach(() => {
                preRenderSpy = jest
                    .spyOn(ts_embed_1.TsEmbed.prototype, 'preRender')
                    .mockResolvedValue(undefined);
                showPreRenderSpy = jest
                    .spyOn(ts_embed_1.TsEmbed.prototype, 'showPreRender')
                    .mockResolvedValue(undefined);
                hidePreRenderSpy = jest
                    .spyOn(ts_embed_1.TsEmbed.prototype, 'hidePreRender')
                    .mockImplementation(() => undefined);
                renderSpy = jest
                    .spyOn(liveboard_1.LiveboardEmbed.prototype, 'render')
                    .mockResolvedValue(undefined);
                destroySpy = jest
                    .spyOn(liveboard_1.LiveboardEmbed.prototype, 'destroy')
                    .mockImplementation(() => undefined);
            });
            afterEach(() => {
                (0, react_2.cleanup)();
            ...
            it('Should preRender PreRenderedLiveboardEmbed with preRenderConfig.id', () => {
                (0, react_2.render)(react_1.default.createElement(index_1.PreRenderedLiveboardEmbed, { preRenderConfig: { id: preRenderId }, liveboardId: "test-liveboard" }));
            ...
            it('Should preRender PreRenderedLiveboardEmbed with the top-level preRenderId', () => {
                (0, react_2.render)(react_1.default.createElement(index_1.PreRenderedLiveboardEmbed, { preRenderId: preRenderId, liveboardId: "test-liveboard" }));
                expect(preRenderSpy).toHaveBeenCalledTimes(1);
                expect(renderSpy).not.toHaveBeenCalled();
            });
            it('Should showPreRender the LiveboardEmbed connected via preRenderConfig', () => {
                const { unmount } = (0, react_2.render)(react_1.default.createElement(index_1.LiveboardEmbed, { preRenderConfig: { id: preRenderId }, liveboardId: "test-liveboard" }));
            ...
            it('Should showPreRender the LiveboardEmbed connected via the top-level preRenderId', () => {
                const { unmount } = (0, react_2.render)(react_1.default.createElement(index_1.LiveboardEmbed, { preRenderId: preRenderId, liveboardId: "test-liveboard" }));
                expect(showPreRenderSpy).toHaveBeenCalledTimes(1);
                expect(renderSpy).not.toHaveBeenCalled();
                unmount();
                expect(hidePreRenderSpy).toHaveBeenCalledTimes(1);
            ...
            it('Should render and destroy the LiveboardEmbed without any preRender id', () => {
                const { unmount } = (0, react_2.render)(react_1.default.createElement(index_1.LiveboardEmbed, { liveboardId: "test-liveboard" }));
        ...
        describe('pre-render wrapper element', () => {
            const wrapperId = (id) => `tsEmbed-pre-render-wrapper-${id}`;
            beforeAll(() => {
            ...
            it('Should create the wrapper with preRenderConfig.id', async () => {
                (0, react_2.render)(react_1.default.createElement(index_1.PreRenderedLiveboardEmbed, { preRenderConfig: { id: preRenderId }, liveboardId: "test-liveboard" }));
                await (0, react_2.waitFor)(() => expect(document.getElementById(wrapperId(preRenderId))).not.toBe(null));
            });
            it('Should prefer preRenderConfig.id over the top-level preRenderId', async () => {
                (0, react_2.render)(react_1.default.createElement(index_1.PreRenderedLiveboardEmbed, { preRenderId: "top-level-pre-render-id", preRenderConfig: { id: 'config-pre-render-id' }, liveboardId: "test-liveboard" }));
                await (0, react_2.waitFor)(() => expect(document.getElementById(wrapperId('config-pre-render-id'))).not.toBe(null));
