 ...
 * @module contracts
 */
import type { ContextType, HostEvent, RuntimeFilter, RuntimeParameter } from '../types';
import type { Applicability, EmbedApiHostEventMapping, UIPassthroughContractBase, UIPassthroughRequest, UIPassthroughResponse } from './ui-passthrough-contracts';
/**
...
export type HostEventRequestByName<NameT extends string> = {
    [EventT in HostEvent]: `${EventT}` extends NameT ? HostEventRequest<EventT> : never;
}[HostEvent] extends never ? any : {
    [EventT in HostEvent]: `${EventT}` extends NameT ? HostEventRequest<EventT> : never;
}[HostEvent];
/**
...
export type HostEventResponseByName<NameT extends string> = {
    [EventT in HostEvent]: `${EventT}` extends NameT ? HostEventResponse<EventT> : never;
}[HostEvent] extends never ? any : {
    [EventT in HostEvent]: `${EventT}` extends NameT ? HostEventResponse<EventT> : never;
}[HostEvent];
export type { UIPassthroughContractBase, EmbedApiHostEventMapping };
//# sourceMappingURL=host-event-contracts.d.ts.map