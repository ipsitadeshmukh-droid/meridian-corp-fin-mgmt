...
const iframe_transport_1 = require("../utils/transport/iframe-transport");
...
class TsEmbed {
    ...
    constructor(domSelector, viewConfig) {
        ...
        this.messageEventListener = (event) => {
            ...
            if ((0, iframe_transport_1.isMessageFromIframe)(event, this.iFrame, this.thoughtSpotHost)) {
    ...
    handleError(errorDetails) {
        ...
        this.executeCallbacks(types_1.EmbedEvent.Error, {
            severity: types_1.EmbedErrorSeverity.SEV3,
            ...errorDetails,
        });
        // Log error
    ...
    subscribeToNetworkEvents() {
        ...
        const offlineEventListener = (e) => {
            const errorDetails = {
                ...
                severity: types_1.EmbedErrorSeverity.SEV2,
    ...
    handleApiInterceptEvent({ eventData, eventPort, }) {
        ...
        const getUnsavedAnswerTml = async (props) => {
            var _a, _b;
            const response = await this.triggerUIPassThrough(ui_passthrough_contracts_1.UIPassthroughEvent.GetUnsavedAnswerTML, props);
    ...
    async getUpdateEmbedParamsObject() {
        ...
        Object.keys(queryParams).forEach((key) => {
            queryParams[key] = (0, utils_1.deserializeParam)(queryParams[key]);
        });
        const appInitData = await this.getAppInitData();
        return {
            ...this.viewConfig,
            ...
            runtimeFilterParams: (0, utils_1.getFilterQuery)((_a = this.viewConfig.runtimeFilters) !== null && _a !== void 0 ? _a : []) || NO_RUNTIME_PARAMS,
            runtimeParameterParams: (0, utils_1.getRuntimeParameters)((_b = this.viewConfig.runtimeParameters) !== null && _b !== void 0 ? _b : [])
                || NO_RUNTIME_PARAMS,
        };
    }
    /**
    ...
    inheritPreRenderContainer() {
        ...
        if (this.getPreRenderConfig().containerSelector
            ...
            logger_1.logger.warn('preRenderContainer is applied only by the component that creates the preRender; '
    ...
    getPreRenderObj() {
        ...
        if (embedObj === this) {
            logger_1.logger.debug('embedObj is same as this');
        }
        return embedObj;
    }
    takeOverPreRender() {
     ...
     */
    async render() {
        (0, mixpanel_service_1.uploadMixpanelEvent)(mixpanel_service_1.MIXPANEL_EVENT.VISUAL_SDK_RENDER_CALLED, {
    ...
    async preRender(showPreRenderByDefault = false, replaceExistingPreRender = false) {
        (0, mixpanel_service_1.uploadMixpanelEvent)(mixpanel_service_1.MIXPANEL_EVENT.VISUAL_SDK_PRE_RENDER, {
    ...
    async showPreRender() {
        var _a, _b;
        (0, mixpanel_service_1.uploadMixpanelEvent)(mixpanel_service_1.MIXPANEL_EVENT.VISUAL_SDK_SHOW_PRE_RENDER, {
    ...
    syncPreRenderStyle() {
        ...
        if (!this.getPreRenderPlaceHolderElement().isConnected) {
            logger_1.logger.debug('syncPreRenderStyle skipped: placeholder is detached');
            return;
        }
     ...
     */
    hidePreRender() {
        (0, mixpanel_service_1.uploadMixpanelEvent)(mixpanel_service_1.MIXPANEL_EVENT.VISUAL_SDK_HIDE_PRE_RENDER, {
            preRenderId: this.getPreRenderConfig().id,
            embedComponentType: this.viewConfig.embedComponentType,
        });
