...
const PASSTHROUGH_MAP = {
    ...
    [types_1.HostEvent.Pin]: ui_passthrough_contracts_1.UIPassthroughEvent.PinAnswerToLiveboard,
    [types_1.HostEvent.SaveAnswer]: ui_passthrough_contracts_1.UIPassthroughEvent.SaveAnswer,
    [types_1.HostEvent.UpdateFilters]: ui_passthrough_contracts_1.UIPassthroughEvent.UpdateFilters,
    [types_1.HostEvent.DrillDown]: ui_passthrough_contracts_1.UIPassthroughEvent.Drilldown,
    // Getters (use getDataWithPassthroughFallback)
    [types_1.HostEvent.GetAnswerSession]: ui_passthrough_contracts_1.UIPassthroughEvent.GetAnswerSession,
    [types_1.HostEvent.GetFilters]: ui_passthrough_contracts_1.UIPassthroughEvent.GetFilters,
    [types_1.HostEvent.GetIframeUrl]: ui_passthrough_contracts_1.UIPassthroughEvent.GetIframeUrl,
    [types_1.HostEvent.GetParameters]: ui_passthrough_contracts_1.UIPassthroughEvent.GetParameters,
    [types_1.HostEvent.GetTML]: ui_passthrough_contracts_1.UIPassthroughEvent.GetTML,
    [types_1.HostEvent.GetTabs]: ui_passthrough_contracts_1.UIPassthroughEvent.GetTabs,
    [types_1.HostEvent.GetGroups]: ui_passthrough_contracts_1.UIPassthroughEvent.GetGroups,
    [types_1.HostEvent.getExportRequestForCurrentPinboard]: ui_passthrough_contracts_1.UIPassthroughEvent.GetExportRequestForCurrentPinboard,
};
class HostEventClient {
    constructor(iFrame) {
        ...
        this.iFrame = iFrame;
        this.customHandlers = {
            [types_1.HostEvent.Pin]: (p, c) => this.handlePinEvent(p, c),
            [types_1.HostEvent.SaveAnswer]: (p, c) => this.handleSaveAnswerEvent(p, c),
            [types_1.HostEvent.UpdateFilters]: (p, c) => this.handleUpdateFiltersEvent(p, c),
            [types_1.HostEvent.UpdateParameters]: (p, c) => this.handleUpdateParametersEvent(p, c),
            [types_1.HostEvent.DrillDown]: (p, c) => this.handleDrillDownEvent(p, c),
        };
    }
    /**
    ...
    async getAvailableUIPassthroughKeys(context) {
        ...
        try {
            const response = await this.triggerUIPassthroughApi(ui_passthrough_contracts_1.UIPassthroughEvent.GetAvailableUIPassthroughs, {}, context);
    ...
    async handlePinEvent(payload, context) {
        ...
        const data = await this.handleHostEventWithParam(ui_passthrough_contracts_1.UIPassthroughEvent.PinAnswerToLiveboard, formattedPayload, context);
        return {
            ...data,
    ...
    async handleSaveAnswerEvent(payload, context) {
        ...
        const data = await this.handleHostEventWithParam(ui_passthrough_contracts_1.UIPassthroughEvent.SaveAnswer, payload, context);
        return {
            ...data,
    ...
    handleUpdateFiltersEvent(payload, context) {
        if (!(0, utils_1.isValidUpdateFiltersPayload)(payload)) {
            (0, utils_1.throwUpdateFiltersValidationError)();
        }
        ...
        // audited.
        return this.handleHostEventWithParam(ui_passthrough_contracts_1.UIPassthroughEvent.UpdateFilters, payload, context);
    }
    handleUpdateParametersEvent(payload, context) {
        if (!(0, utils_1.isValidUpdateParametersPayload)(payload)) {
            (0, utils_1.throwUpdateParametersValidationError)();
        }
        // UpdateParameters has no UI passthrough contract; dispatch over the legacy channel
        return this.hostEventFallback(types_1.HostEvent.UpdateParameters, payload, context);
    }
    handleDrillDownEvent(payload, context) {
        if (!(0, utils_1.isValidDrillDownPayload)(payload)) {
            (0, utils_1.throwDrillDownValidationError)();
        }
        return this.handleHostEventWithParam(ui_passthrough_contracts_1.UIPassthroughEvent.Drilldown, payload, context);
    }
    /**
