...
const ui_passthrough_contracts_1 = require("../../contracts/ui-passthrough-contracts");
...
describe('HostEventClient', () => {
    ...
    describe('executeUIPassthroughApi', () => {
        it('should call processTrigger with correct parameters and return response', async () => {
            ...
            const apiName = ui_passthrough_contracts_1.UIPassthroughEvent.PinAnswerToLiveboard;
            const parameters = {
                newVizName: 'testViz',
            };
    ...
    describe('executeHostEvent', () => {
        const mockGetAvailablePassthroughs = () => [{ value: { keys: Object.values(ui_passthrough_contracts_1.UIPassthroughEvent) } }];
        it('should call handleUIPassthroughForHostEvent for Pin event', async () => {
            ...
            expect(mockProcessTrigger).toHaveBeenCalledWith(mockIframe, types_1.HostEvent.UIPassthrough, 'http://localhost', { parameters: payload, type: ui_passthrough_contracts_1.UIPassthroughEvent.PinAnswerToLiveboard }, undefined);
        ...
        it('should call handleHostEventWithParam for UpdateFilters event', async () => {
            ...
            const result = await client.triggerHostEvent(hostEvent, payload);
            expect(mockProcessTrigger).toHaveBeenCalledWith(mockIframe, types_1.HostEvent.UIPassthrough, mockThoughtSpotHost, {
                type: ui_passthrough_contracts_1.UIPassthroughEvent.UpdateFilters,
                parameters: payload,
            }, undefined);
        ...
        it('should call handleHostEventWithParam for DrillDown event', async () => {
            ...
            const result = await client.triggerHostEvent(hostEvent, payload);
            expect(mockProcessTrigger).toHaveBeenCalledWith(mockIframe, types_1.HostEvent.UIPassthrough, mockThoughtSpotHost, {
                type: ui_passthrough_contracts_1.UIPassthroughEvent.Drilldown,
                parameters: payload,
            }, undefined);
        ...
        it('should accept UpdateFilters with filters array', async () => {
            ...
            expect(mockProcessTrigger).toHaveBeenNthCalledWith(2, mockIframe, types_1.HostEvent.UIPassthrough, mockThoughtSpotHost, { type: ui_passthrough_contracts_1.UIPassthroughEvent.UpdateFilters, parameters: payload }, undefined);
            expect(result).toEqual({ success: true });
        });
        ...
        it('should pass context to UpdateFilters event', async () => {
            ...
            expect(mockProcessTrigger).toHaveBeenCalledWith(mockIframe, types_1.HostEvent.UIPassthrough, mockThoughtSpotHost, { type: ui_passthrough_contracts_1.UIPassthroughEvent.UpdateFilters, parameters: payload }, context);
        });
        it('should dispatch UpdateParameters over the legacy channel', async () => {
            ...
            const result = await client.triggerHostEvent(types_1.HostEvent.UpdateParameters, payload);
            expect(mockProcessTrigger).toHaveBeenCalledTimes(1);
            expect(mockProcessTrigger).toHaveBeenCalledWith(mockIframe, types_1.HostEvent.UpdateParameters, mockThoughtSpotHost, payload, undefined);
            expect(result).toEqual({ success: true });
        });
        it('should forward UpdateParameters with null applicability', async () => {
            ...
            mockProcessTrigger.mockResolvedValueOnce({ success: true });
            await client.triggerHostEvent(types_1.HostEvent.UpdateParameters, payload);
            expect(mockProcessTrigger).toHaveBeenCalledWith(mockIframe, types_1.HostEvent.UpdateParameters, mockThoughtSpotHost, payload, undefined);
        });
        it('should throw when UpdateParameters entry has invalid applicability', async () => {
            ...
            await expect(client.triggerHostEvent(types_1.HostEvent.UpdateParameters, invalidPayload))
        ...
        it('should pass context to UpdateParameters event', async () => {
            ...
            mockProcessTrigger.mockResolvedValueOnce({ success: true });
            await client.triggerHostEvent(types_1.HostEvent.UpdateParameters, payload, context);
            expect(mockProcessTrigger).toHaveBeenCalledWith(mockIframe, types_1.HostEvent.UpdateParameters, mockThoughtSpotHost, payload, context);
        });
        it('should route GetGroups through passthrough and return data', async () => {
            const { client } = createHostEventClient();
            const mockResponse = [{ value: { orderedGroupIds: ['g1', 'g2'], numberOfGroups: 2, Groups: [] } }];
            mockProcessTrigger
                .mockResolvedValueOnce(mockGetAvailablePassthroughs())
                .mockResolvedValueOnce(mockResponse);
            const result = await client.triggerHostEvent(types_1.HostEvent.GetGroups, {});
        ...
        it('should pass context to DrillDown event', async () => {
            ...
            expect(mockProcessTrigger).toHaveBeenCalledWith(mockIframe, types_1.HostEvent.UIPassthrough, mockThoughtSpotHost, { type: ui_passthrough_contracts_1.UIPassthroughEvent.Drilldown, parameters: payload }, context);
        });
        ...
        it('should route GetAnswerSession through passthrough and return data', async () => {
            ...
            mockProcessTrigger
                ...
                .mockResolvedValueOnce(mockResponse);
            const result = await client.triggerHostEvent(types_1.HostEvent.GetAnswerSession, { vizId: '123' });
            expect(mockProcessTrigger).toHaveBeenNthCalledWith(2, mockIframe, types_1.HostEvent.UIPassthrough, mockThoughtSpotHost, { type: ui_passthrough_contracts_1.UIPassthroughEvent.GetAnswerSession, parameters: { vizId: '123' } }, undefined);
        ...
        it('should route GetFilters through passthrough and return data', async () => {
            ...
            expect(mockProcessTrigger).toHaveBeenCalledWith(mockIframe, types_1.HostEvent.UIPassthrough, mockThoughtSpotHost, { type: ui_passthrough_contracts_1.UIPassthroughEvent.GetFilters, parameters: {} }, undefined);
    ...
    describe('getDataWithPassthroughFallback', () => {
        ...
        it('should return unwrapped value when passthrough succeeds', async () => {
            ...
            const result = await callMethod(client, ui_passthrough_contracts_1.UIPassthroughEvent.GetAnswerSession, types_1.HostEvent.GetAnswerSession, { vizId: '1' });
        ...
        it('should fall back to legacy when passthrough returns null', async () => {
            ...
            mockProcessTrigger
                .mockResolvedValueOnce(null)
                .mockResolvedValueOnce(legacyResponse);
            const result = await callMethod(client, ui_passthrough_contracts_1.UIPassthroughEvent.GetParameters, types_1.HostEvent.GetParameters, {});
            expect(mockProcessTrigger).toHaveBeenCalledTimes(2);
            expect(result).toEqual(legacyResponse);
        });
        it('should fall back to legacy when passthrough returns undefined', async () => {
            ...
            mockProcessTrigger
                ...
                .mockResolvedValueOnce(legacyResponse);
            const result = await callMethod(client, ui_passthrough_contracts_1.UIPassthroughEvent.GetIframeUrl, types_1.HostEvent.GetIframeUrl, {});
            expect(mockProcessTrigger).toHaveBeenCalledTimes(2);
            expect(result).toEqual(legacyResponse);
        });
        it('should fall back when response array has no matching entries', async () => {
            ...
            mockProcessTrigger
                ...
                .mockResolvedValueOnce(legacyResponse);
            const result = await callMethod(client, ui_passthrough_contracts_1.UIPassthroughEvent.GetExportRequestForCurrentPinboard, types_1.HostEvent.getExportRequestForCurrentPinboard, {});
            expect(mockProcessTrigger).toHaveBeenCalledTimes(2);
            expect(result).toEqual(legacyResponse);
        });
        it('should throw when response has error field', async () => {
            ...
            await expect(callMethod(client, ui_passthrough_contracts_1.UIPassthroughEvent.GetFilters, types_1.HostEvent.GetFilters, {})).rejects.toThrow('Permission denied');
            expect(mockProcessTrigger).toHaveBeenCalledTimes(1);
        });
        it('should throw when response value contains errors field', async () => {
            ...
            await expect(callMethod(client, ui_passthrough_contracts_1.UIPassthroughEvent.GetTML, types_1.HostEvent.GetTML, { vizId: 'bad' })).rejects.toThrow('Invalid vizId');
            expect(mockProcessTrigger).toHaveBeenCalledTimes(1);
        });
        it('should throw when response value contains error field', async () => {
            const { client } = createHostEventClient();
            mockProcessTrigger.mockResolvedValue([{ value: { error: 'Not found' } }]);
            await expect(callMethod(client, ui_passthrough_contracts_1.UIPassthroughEvent.GetTabs, types_1.HostEvent.GetTabs, {})).rejects.toThrow('Not found');
            expect(mockProcessTrigger).toHaveBeenCalledTimes(1);
        });
        it('should stringify object errors instead of producing [object Object]', async () => {
            ...
            await expect(callMethod(client, ui_passthrough_contracts_1.UIPassthroughEvent.GetFilters, types_1.HostEvent.GetFilters, {})).rejects.toThrow(JSON.stringify(errorObj));
            expect(mockProcessTrigger).toHaveBeenCalledTimes(1);
        });
        it('should default payload to empty object when null', async () => {
            ...
            await callMethod(client, ui_passthrough_contracts_1.UIPassthroughEvent.GetIframeUrl, types_1.HostEvent.GetIframeUrl, null);
            expect(mockProcessTrigger).toHaveBeenCalledWith(mockIframe, types_1.HostEvent.UIPassthrough, mockThoughtSpotHost, { type: ui_passthrough_contracts_1.UIPassthroughEvent.GetIframeUrl, parameters: {} }, undefined);
        });
    });
    describe('UI passthrough available keys tests', () => {
        const mockKeys = () => [{ value: { keys: Object.values(ui_passthrough_contracts_1.UIPassthroughEvent) } }];
    ...
    describe('availablePassthroughKeysCache reuse', () => {
        const allKeys = () => [{ value: { keys: Object.values(ui_passthrough_contracts_1.UIPassthroughEvent) } }];
        it('GetFilters: second call reuses cache — GetAvailableUIPassthroughs called only once', async () => {
            ...
            mockProcessTrigger
                ...
                .mockResolvedValueOnce(filterResponse);
            await client.triggerHostEvent(types_1.HostEvent.GetFilters, {});
            await client.triggerHostEvent(types_1.HostEvent.GetFilters, {});
            // 3 calls total: 1 GetAvailableUIPassthroughs + 2 GetFilters
            expect(mockProcessTrigger).toHaveBeenCalledTimes(3);
            expect(mockProcessTrigger).not.toHaveBeenNthCalledWith(3, expect.anything(), types_1.HostEvent.UIPassthrough, mockThoughtSpotHost, expect.objectContaining({ type: ui_passthrough_contracts_1.UIPassthroughEvent.GetAvailableUIPassthroughs }), undefined);
        });
        it('GetTabs: second call reuses cache — GetAvailableUIPassthroughs called only once', async () => {
            ...
            mockProcessTrigger
                ...
                .mockResolvedValueOnce(tabResponse);
            await client.triggerHostEvent(types_1.HostEvent.GetTabs, {});
            await client.triggerHostEvent(types_1.HostEvent.GetTabs, {});
            expect(mockProcessTrigger).toHaveBeenCalledTimes(3);
        });
        it('GetParameters: second call reuses cache — GetAvailableUIPassthroughs called only once', async () => {
            ...
            mockProcessTrigger
                ...
                .mockResolvedValueOnce(paramResponse);
            await client.triggerHostEvent(types_1.HostEvent.GetParameters, {});
            await client.triggerHostEvent(types_1.HostEvent.GetParameters, {});
            expect(mockProcessTrigger).toHaveBeenCalledTimes(3);
        });
        it('GetAnswerSession: second call reuses cache — GetAvailableUIPassthroughs called only once', async () => {
            ...
            mockProcessTrigger
                ...
                .mockResolvedValueOnce(sessionResponse);
            await client.triggerHostEvent(types_1.HostEvent.GetAnswerSession, {});
            await client.triggerHostEvent(types_1.HostEvent.GetAnswerSession, {});
            expect(mockProcessTrigger).toHaveBeenCalledTimes(3);
        });
        it('UIPassthrough direct trigger does not populate the cache', async () => {
            ...
            await client.triggerHostEvent(types_1.HostEvent.UIPassthrough, {});
        ...
        it('GetAnswerSession: catch in getAvailableUIPassthroughKeys does not cache, so next call retries GetAvailableUIPassthroughs', async () => {
            ...
            await client.triggerHostEvent(types_1.HostEvent.GetAnswerSession, { vizId: '1' });
            ...
            await client.triggerHostEvent(types_1.HostEvent.GetAnswerSession, { vizId: '2' });
            ...
            const availableCallsCount = mockProcessTrigger.mock.calls.filter((call) => { var _a; return ((_a = call[3]) === null || _a === void 0 ? void 0 : _a.type) === ui_passthrough_contracts_1.UIPassthroughEvent.GetAvailableUIPassthroughs; }).length;
    ...
    describe('GetTML edge cases', () => {
        ...
        it('includeNonExecutedSearchTokens flag is forwarded in UIPassthrough parameters', async () => {
            ...
            await client.triggerHostEvent(types_1.HostEvent.GetTML, { includeNonExecutedSearchTokens: true });
            expect(mockProcessTrigger).toHaveBeenNthCalledWith(2, mockIframe, types_1.HostEvent.UIPassthrough, mockThoughtSpotHost, {
                type: ui_passthrough_contracts_1.UIPassthroughEvent.GetTML,
        ...
        it('value.error (singular) throws — distinct from value.errors', async () => {
            ...
            await expect(client.triggerHostEvent(types_1.HostEvent.GetTML, {}))
        ...
        it('GetTML key absent from non-empty keys array falls back to legacy hostEventFallback', async () => {
            ...
            mockProcessTrigger
                .mockResolvedValueOnce([{ value: { keys: [ui_passthrough_contracts_1.UIPassthroughEvent.GetFilters] } }])
                .mockResolvedValueOnce({ answer: { search_query: 'revenue' } });
            const result = await client.triggerHostEvent(types_1.HostEvent.GetTML, {});
            expect(mockProcessTrigger).toHaveBeenNthCalledWith(2, mockIframe, types_1.HostEvent.GetTML, mockThoughtSpotHost, {}, undefined);
    ...
    describe('SaveAnswer key-presence edge cases', () => {
        ...
        it('name+description both empty string route through passthrough, not Save fallback', async () => {
            ...
            await client.triggerHostEvent(types_1.HostEvent.SaveAnswer, { name: '', description: '' });
            expect(mockProcessTrigger).toHaveBeenNthCalledWith(2, mockIframe, types_1.HostEvent.UIPassthrough, mockThoughtSpotHost, { type: ui_passthrough_contracts_1.UIPassthroughEvent.SaveAnswer, parameters: { name: '', description: '' } }, undefined);
        });
        it('description: undefined (key present) routes through passthrough, not Save fallback', async () => {
            ...
            mockProcessTrigger
                .mockResolvedValueOnce(allKeys())
                .mockResolvedValueOnce(saveResponse);
            await client.triggerHostEvent(types_1.HostEvent.SaveAnswer, { name: 'Test', description: undefined });
            expect(mockProcessTrigger).toHaveBeenNthCalledWith(2, mockIframe, types_1.HostEvent.UIPassthrough, mockThoughtSpotHost, { type: ui_passthrough_contracts_1.UIPassthroughEvent.SaveAnswer, parameters: { name: 'Test', description: undefined } }, undefined);
        });
        it('name key absent falls back to HostEvent.Save', async () => {
            ...
            await client.triggerHostEvent(types_1.HostEvent.SaveAnswer, { description: 'desc only' });
            expect(mockProcessTrigger).toHaveBeenCalledWith(mockIframe, types_1.HostEvent.Save, mockThoughtSpotHost, { description: 'desc only' }, undefined);
        });
        it('answerId is undefined when saveResponse.data.Answer__save.answer.id is missing', async () => {
            ...
            const result = await client.triggerHostEvent(types_1.HostEvent.SaveAnswer, { name: 'Test', description: 'Desc' });
    ...
    describe('trigger typing contracts (compile-time)', () => {
        it('infers typed response for no-payload contracted events and keeps any for uncontracted', () => {
            ...
            const getTabs = () => client.triggerHostEvent(types_1.HostEvent.GetTabs);
            ...
            const reload = () => client.triggerHostEvent(types_1.HostEvent.Reload);
